...
public class MyEntityTobo extends EntityMob
{
    ...
    public MyEntityTobo(World par1World)
    {
        super(par1World);
    ...
    public void onLivingUpdate()
    {
        if (!this.worldObj.isRemote)
        {
            if (this.isWet())
            {
                this.attackEntityFrom(DamageSource.anvil, 20.0F);
                this.attackEntityFrom(DamageSource.cactus, 20.0F);
                this.attackEntityFrom(DamageSource.wither, 20.0F);
                this.attackEntityFrom(DamageSource.magic, 20.0F);              
                this.attackEntityFrom(DamageSource.fall, 20.0F);
            }
