...
public class MyEntityCreeper extends EntityZombie
{
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setAttribute(8.5D);
        ...
        else
        {
            ...
            if (entity instanceof EntityPlayer)
            {
                ...
                for (int i = 0; i < list.size(); ++i)
                {
                    ...
                    if (entity1 instanceof MyEntityCreeper)
                    {
                        MyEntityCreeper entitypigzombie = (MyEntityCreeper)entity1;
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        for (k = 0; k < j; ++k)
        {
            this.dropItem(Item.axeDiamond.itemID, 1);
        }
