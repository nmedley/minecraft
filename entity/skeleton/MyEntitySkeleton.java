...
public class MyEntitySkeleton extends EntityMob implements IRangedAttackMob
{
    ...
    public void onLivingUpdate()
    {
        ...
        {
            float f = this.getBrightness(2.0F);
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        else
        {
            ...
            for (k = 0; k < j; ++k)
            {
                this.dropItem(Main.MySword_1.itemID, 1);
            }
        }
        ...
        for (k = 0; k < j; ++k)
        {
            this.dropItem(Main.MyHelmet_1.itemID, 1);
        }
        {
            this.dropItem(Main.MyChest_1.itemID, 1);
        }
        {
            this.dropItem(Main.MyLeggings_1.itemID, 1);
        }
        {
            this.dropItem(Main.MyBoots_1.itemID, 1);
        }                
    }
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase par1EntityLivingBase, float par2)
    {
        ...
        if (EnchantmentHelper.getEnchantmentLevel(Enchantment.knockback.effectId, this.getHeldItem()) > 0 || this.getSkeletonType() == 1)
        if (EnchantmentHelper.getEnchantmentLevel(Enchantment.sharpness.effectId, this.getHeldItem()) > 0 || this.getSkeletonType() == 1)
        if (EnchantmentHelper.getEnchantmentLevel(Enchantment.unbreaking.effectId, this.getHeldItem()) > 0 || this.getSkeletonType() == 1)       
