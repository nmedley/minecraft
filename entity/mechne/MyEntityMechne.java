...
public class MyEntityMechne extends EntityMob implements IRangedAttackMob
{
    private EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack(this, 1.0D, 20, 60, 15.0F);
    private EntityAIAttackOnCollide aiAttackOnCollide = new EntityAIAttackOnCollide(this, EntityPlayer.class, 1.2D, false);

    public MyEntityMechne(World par1World)
    {
        super(par1World);
    ...
    {
        return "fireworks.largeBlast_far1";
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if (this.getSkeletonType() == 1)
        {
            ...
            for (k = 0; k < j; ++k)
            {
                this.dropItem(Item.horseArmorDiamond.itemID, 1);
            }
        }
        else
        {
            ...
            for (k = 0; k < j; ++k)
            {
                this.dropItem(Item.brewingStand.itemID, 1);
            }
        }
        ...
        for (k = 0; k < j; ++k)
        {
            this.dropItem(Item.bucketLava.itemID, 1);
        }
    }
    ...
    protected void dropRareDrop(int par1)
    {
        if (this.getSkeletonType() == 1)
        {
            this.entityDropItem(new ItemStack(Item.potion.itemID, 4, 4), 0.0F);
        }
    }
    ...
    protected void addRandomArmor()
    {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack(Main.MySword_1));
    }
